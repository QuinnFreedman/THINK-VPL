...
class DisplayPanel extends JPanel{
	...
	DisplayPanel(GraphEditor owner){
		...
		MouseAdapter ma = new DisplayPanel.DragMouseAdapter(this);
	...
	static class DragMouseAdapter extends MouseAdapter  {
        ...
        DragMouseAdapter(JPanel panelHolder){
        ...
        public void mouseDragged(MouseEvent e) {
            if (origin != null) {
                JViewport viewPort = (JViewport) SwingUtilities.getAncestorOfClass(JViewport.class, panelHolder);
                if (viewPort != null) {
                    ...
                    panelHolder.scrollRectToVisible(view);
                }
            }
        }
